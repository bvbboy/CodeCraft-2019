...
int main(int argc, char *argv[])
{
    ...
    // for debug
    string carPath("../2-map-training-1/car.txt");
    string roadPath("../2-map-training-1/road.txt");
    string crossPath("../2-map-training-1/cross.txt");
    string presetPath("../2-map-training-1/presetAnswer.txt");
    string answerPath("../2-map-training-1/answer.txt");
    // end
	
	std::cout << "carPath is " << carPath << std::endl;
	std::cout << "roadPath is " << roadPath << std::endl;
	std::cout << "crossPath is " << crossPath << std::endl;
    std::cout << "presetPath is " << presetPath << std::endl;
	std::cout << "answerPath is " << answerPath << std::endl;
...
//    int num_presetCars = read_presetcarfile(presetPath,g);
